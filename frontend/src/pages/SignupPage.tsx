    ...
    >
      ...
      <div className="card-appear w-full max-w-sm px-4 relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-white/30 text-xs mt-1.5 tracking-wider">Create your account</p>
        </div>
        ...
        >
          <h1 className="text-white text-lg font-semibold tracking-tight">Create account</h1>

          <div className="space-y-1.5">
            <Label htmlFor="name" className="text-white/50 text-xs tracking-wide">Name</Label>
            <Input
              id="name"
              type="text"
              value={name}
          ...
          <p className="text-center text-white/30 text-sm">
            ...
            <Link to="/login" className="text-amber-400/70 hover:text-amber-400 transition-colors underline underline-offset-2">
              Sign in
            </Link>
          </p>
        </form>
