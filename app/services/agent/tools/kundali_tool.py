...
def generate_kundali_chart(
    ...
    # Exclude position, deviation, and moon_deviate as they're internal calculation details
    result = {
    ...
    # Convert planet data to dictionaries (excluding position and deviation)
